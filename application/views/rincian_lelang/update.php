                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" name="jml_peserta" class="form-control <?= form_error('jml_peserta') ? 'is-invalid' : ''; ?>" value="<?= $rincian_lelang['jml_peserta']; ?>">
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" name="ujl" class="form-control <?= form_error('ujl') ? 'is-invalid' : ''; ?>" value="<?= $rincian_lelang['ujl']; ?>">
                                <div class="invalid-feedback">
                                    <?= form_error('ujl'); ?>
                                </div>
                            </div>
