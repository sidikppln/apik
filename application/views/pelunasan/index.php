          ...
          <tbody>
            ...
            foreach ($pelunasan as $r) : ?>
              <tr>
                ...
                <td>
                  <a href="<?= base_url('pelunasan/true-delete/') . $r['id'] . '/' . $r['transaksi_bank_id']; ?>" class="btn btn-sm btn-outline-success pt-0 pb-0" onclick="return confirm('Apakah Anda yakin akan menghapus data ini?');">Hapus</a>
                </td>
              </tr>
            <?php endforeach; ?>
          </tbody>
