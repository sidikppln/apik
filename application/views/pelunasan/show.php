  ...
  <section class="content">
    ...
    <div class="card">
      <div class="card-header">
        <div class="row">
          <div class="col-lg-6">
            <a href="<?= base_url('pelunasan/create/') . $nota_penerimaan_id . '/' . $kode . '/a'; ?>" class="btn btn-sm btn-outline-success">Tambah</a>
          </div>
          <div class="col-lg-6">
          ...
          <tbody>
            ...
            foreach ($pelunasan as $r) : ?>
              <tr>
                ...
                <td>
                  <a href="<?= base_url('pelunasan/delete/') . $r['id'] . '/' . $nota_penerimaan_id . '/' . $r['kode_kelompok'] . $r['kode_jenis'] . $r['kode_sub_jenis']; ?>" class="btn btn-sm btn-outline-success pt-0 pb-0" onclick="return confirm('Apakah Anda yakin akan menghapus data ini?');">Hapus</a>
                </td>
              </tr>
            <?php endforeach; ?>
          </tbody>
