  ...
  <section class="content">
    ...
    <div class="card">
      <div class="card-header">
        <div class="row">
          <div class="col-lg-6">
            <a href="<?= base_url('nota-pengeluaran/detail/') . $jenis_aktivitas . '/' . $aktivitas_id; ?>" class="btn btn-sm btn-outline-info">Kembali</a>
            <a href="<?= base_url('nota-pengeluaran/create-transaksi/') . $jenis_aktivitas . '/' . $aktivitas_id . '/' . $nota_pengeluaran_id . '/' . $kode_nota; ?>" class="btn btn-sm btn-outline-info ml-2">Tambah</a>
          </div>
          <div class="col-lg-6">
