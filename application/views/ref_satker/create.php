                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" name="no_urut_penerimaan" class="form-control <?= form_error('no_urut_penerimaan') ? 'is-invalid' : ''; ?>">
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" name="no_nota_penerimaan" class="form-control <?= form_error('no_nota_penerimaan') ? 'is-invalid' : ''; ?>">
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" name="no_urut_pengeluaran" class="form-control <?= form_error('no_urut_pengeluaran') ? 'is-invalid' : ''; ?>">
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" name="no_nota_pengeluaran" class="form-control <?= form_error('no_nota_pengeluaran') ? 'is-invalid' : ''; ?>">
                                <div class="invalid-feedback">
