...
class Pengesahan extends CI_Controller
{
    ...
    public function index($jenis_aktivitas = 1)
    {
        ...
        // setting halaman
        $config['base_url'] = base_url('pengesahan/index/' . $jenis_aktivitas . '');
        ...
        $this->load->view('pengesahan/index', $data);
    ...
    public function detail($jenis_aktivitas = 1, $aktivitas_id = null)
    {
        ...
        $this->load->view('template/header');
        $this->load->view('template/sidebar');
        $this->load->view('pengesahan/detail', $data);
        $this->load->view('template/footer');
    }
    ...
    public function transaksi_penerimaan($jenis_aktivitas = 1, $aktivitas_id = null, $nota_penerimaan_id = null)
    {
        ...
        // setting halaman
        $config['base_url'] = base_url('pengesahan/transaksi-penerimaan/' . $jenis_aktivitas . '/' . $aktivitas_id . '/' . $nota_penerimaan_id . '');
        ...
        $this->load->view('template/header');
        $this->load->view('template/sidebar');
        $this->load->view('pengesahan/transaksi_penerimaan', $data);
        $this->load->view('template/footer');
    }
    ...
    public function transaksi_pengeluaran($jenis_aktivitas = 2, $aktivitas_id = null, $nota_pengeluaran_id = null)
    {
        ...
        // setting halaman
        $config['base_url'] = base_url('pengesahan/transaksi-pengeluaran/' . $jenis_aktivitas . '/' . $aktivitas_id . '/' . $nota_pengeluaran_id . '');
        ...
        $this->load->view('template/header');
        $this->load->view('template/sidebar');
        $this->load->view('pengesahan/transaksi_pengeluaran', $data);
        $this->load->view('template/footer');
    }
    ...
    public function proses($jenis_aktivitas = 0, $aktivitas_id = null, $id = null, $jenis_nota = 1)
    {
        ...
        redirect('pengesahan/detail/' . $jenis_aktivitas . '/' . $aktivitas_id . '');
    }
