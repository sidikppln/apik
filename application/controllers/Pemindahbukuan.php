...
class Pemindahbukuan extends CI_Controller
{
    ...
    public function index($jenis_aktivitas = 1)
    {
        ...
        // setting halaman
        $config['base_url'] = base_url('pemindahbukuan/index/' . $jenis_aktivitas . '');
        ...
        $this->load->view('pemindahbukuan/index', $data);
    ...
    public function detail($jenis_aktivitas = 1, $aktivitas_id = null)
    {
        ...
        $this->load->view('template/header');
        $this->load->view('template/sidebar');
        $this->load->view('pemindahbukuan/detail', $data);
        $this->load->view('template/footer');
    }
    ...
    public function transaksi_penerimaan($jenis_aktivitas = 1, $aktivitas_id = null, $nota_penerimaan_id = null)
    {
        ...
        // setting halaman
        $config['base_url'] = base_url('pemindahbukuan/transaksi-penerimaan/' . $jenis_aktivitas . '/' . $aktivitas_id . '/' . $nota_penerimaan_id . '');
        ...
        $this->load->view('template/header');
        $this->load->view('template/sidebar');
        $this->load->view('pemindahbukuan/transaksi_penerimaan', $data);
        $this->load->view('template/footer');
    }
    ...
    public function transaksi_pengeluaran($jenis_aktivitas = 2, $aktivitas_id = null, $nota_pengeluaran_id = null)
    {
        ...
        // setting halaman
        $config['base_url'] = base_url('pemindahbukuan/transaksi-pengeluaran/' . $jenis_aktivitas . '/' . $aktivitas_id . '/' . $nota_pengeluaran_id . '');
        ...
        $this->load->view('template/header');
        $this->load->view('template/sidebar');
        $this->load->view('pemindahbukuan/transaksi_pengeluaran', $data);
        $this->load->view('template/footer');
    }
    ...
    public function proses($jenis_aktivitas = 0, $aktivitas_id = null, $id = null, $jenis_nota = 1)
    {
        ...
        redirect('pemindahbukuan/detail/' . $jenis_aktivitas . '/' . $aktivitas_id . '');
    }
