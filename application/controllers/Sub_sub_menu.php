...
class Sub_sub_menu extends CI_Controller
{
    ...
    public function index($menu_id = null, $sub_menu_id = null)
    {
        ...
        $this->load->view('sub_sub_menu/index', $data);
    ...
    public function create($menu_id = null, $sub_menu_id = null)
    {
        $data['menu_id'] = $menu_id;
        $data['sub_menu_id'] = $sub_menu_id;
        ...
        if ($validation->run()) {
            ...
            redirect('sub-sub-menu/index/' . $menu_id . '/' . $sub_menu_id . '');
        }

        $this->load->view('template/header');
        $this->load->view('template/sidebar');
        $this->load->view('sub_sub_menu/create', $data);
        $this->load->view('template/footer');
    }

    public function update($id, $menu_id, $sub_menu_id = null)
    {
        ...
        $this->load->view('template/header');
        $this->load->view('template/sidebar');
        $this->load->view('sub_sub_menu/update', $data);
        $this->load->view('template/footer');
    }

    public function delete($id, $menu_id, $sub_menu_id = null)
    {
        if (!isset($id)) show_404();
